...
/****** Object:  StoredProcedure [dbo].[SPR_PAGAMENTO_SELECIONAR]    Script Date: 11/12/2015 17:57:25 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SPR_PAGAMENTO_SELECIONAR]') AND type in (N'P', N'PC'))
